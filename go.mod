module github.com/imkarthi24/sf-backend
...
require (
	...
	github.com/loop-kar/pixie v0.0.0-20260119211000-b9f927d62726
...
require (
	...
	github.com/newrelic/go-agent/v3/integrations/nrgin v1.4.2 // indirect
